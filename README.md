...
![Status](https://github.com/afsin-asf/goproxy-utls/workflows/Go/badge.svg)
[![GoDoc](https://pkg.go.dev/badge/github.com/afsin-asf/goproxy-utls)](https://pkg.go.dev/github.com/afsin-asf/goproxy-utls)
[![Go Report](https://goreportcard.com/badge/github.com/afsin-asf/goproxy-utls)](https://goreportcard.com/report/github.com/afsin-asf/goproxy-utls)
...
You also have to [trust](https://github.com/afsin-asf/goproxy-utls/blob/master/examples/customca/README.md)
...
### Let's start
```go
import "github.com/afsin-asf/goproxy-utls"
```
